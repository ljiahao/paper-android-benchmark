...
To better support subsequent research and foster replicability, we provide the hyper-parameters of these approaches.
...
In our experiments, we chose the family mode, as it is more efficient in terms of time and memory.
...
\begin{table}[t]
    ...
    \caption{The effectiveness of the selected approaches using different-sized training data.}
    \vspace{-0.1cm}
