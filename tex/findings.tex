...
Diverse APK features, such as permissions and intents, have been leveraged to identify malware~\cite{xu2018deeprefiner,arp2014drebin,kim2018multimodal}. 
These features profile apps and play a pivotal role in shaping the effectiveness of malware detectors.
Our findings indicate that heuristic feature selection can help reduce noise in the feature space, enabling models to identify malicious patterns more effectively, particularly in scenarios with limited data.
However, we also observe that the semantics of various features are not always complementary, and how to combine them does not be well explored.
Simply incorporating additional features does not necessarily lead to improved performance.
