...
To validate the trend towards ML-based Android malware detection, we conduct a systematic investigation of the literature, which can be found in Sec.~\ref{sec:discussion}.
...
We then design and release a general-purpose framework, \codename, together with a large-scale, realistic dataset (see Sec.~\ref{sec:framework}), enabling the most comprehensive and wide-ranging comparative analysis to date.
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.73\linewidth]{fig/representation.pdf}
    \vspace{-0.1cm}
