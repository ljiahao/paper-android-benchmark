...
In particular, some prominent regional app stores --- such as Huawei AppGallery, Xiaomi, and other OEM-operated markets --- are not included.
...
Nevertheless, during dataset construction, we explicitly ensured that our samples include apps originating from multiple markets within AndroZoo, rather than being dominated by a single source.
As a result, our analysis and findings are grounded in behaviors observed across different app markets, which mitigates the risk that our conclusions are driven by market-specific biases.
