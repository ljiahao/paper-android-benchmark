...
For example, when designing a new detector based on API calls and permissions, users can easily retrieve these features from the \textit{feature database} and feed them into their proposed model for evaluation.
